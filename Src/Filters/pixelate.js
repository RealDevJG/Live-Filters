function fastPixelateFilter(_img)
{
    ...
    // The idea is that a blurred image already has colour information from the pixels around it baked in so it's like taking the average, just faster
    fastBlur(_img, 2);
...
// and can still see that it won't be fast enough. My guess is that it's ~8ms too slow)
